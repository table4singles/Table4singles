    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="text-center py-20">
          <p className="text-gray-500 dark:text-gray-400">Esta sección es solo para cuentas de usuario.</p>
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 pb-24 md:pb-8">
        ...
        {showFilters && (
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 mb-6 animate-fade-in space-y-5">
            ...
            <div>
              <h4 className="text-sm text-gray-600 dark:text-gray-300 mb-2">Ciudad</h4>
              <input
                type="text"
            ...
            <div>
              <h4 className="text-sm text-gray-600 dark:text-gray-300 mb-2">Idiomas</h4>
            ...
            <div>
              <h4 className="text-sm text-gray-600 dark:text-gray-300 mb-2">Intereses</h4>
              <div className="flex flex-wrap gap-2">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">No hay comensales para mostrar</h3>
            <p className="text-gray-500 dark:text-gray-400">{hasFilters ? 'Ajusta los filtros de búsqueda' : 'Vuelve pronto, la comunidad está creciendo'}</p>
          </div>
        ) : (
          <>
