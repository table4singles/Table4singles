  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 pb-24 lg:pb-8">
        ...
        {/* Desktop: banner arriba a todo lo ancho; contenido principal (KPIs + próximas mesas) a
            la izquierda, accesos rápidos como columna fija a la derecha. Móvil: todo apilado en
            el mismo orden que antes (banner, KPIs, accesos, mesas) — el grid solo actúa en lg:. */}
        <div className="lg:grid lg:grid-cols-3 lg:gap-6 lg:items-start">

          {/* Banner de suscripción */}
          {profile?.subscription_status === 'active' || profile?.subscription_status === 'trialing' ? (
            <div className="lg:col-start-1 lg:col-span-3 lg:row-start-1 flex items-center gap-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl px-4 py-3 mb-6 lg:mb-0 text-sm">
            ...
            <div className="lg:col-start-1 lg:col-span-3 lg:row-start-1 flex items-center gap-3 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl px-4 py-3 mb-6 lg:mb-0 text-sm">
            ...
            <div className="lg:col-start-1 lg:col-span-3 lg:row-start-1 flex items-center gap-3 bg-[#129a93]/5 border border-[#129a93]/20 rounded-xl px-4 py-3 mb-6 lg:mb-0">
          ...
          <div className="lg:col-start-1 lg:col-span-2 lg:row-start-2 grid grid-cols-3 gap-2 sm:gap-4 mb-8 lg:mb-0">
          ...
          {/* Quick access shortcuts — columna fija a la derecha en desktop */}
          <div className="lg:col-start-3 lg:col-span-1 lg:row-start-2 lg:row-span-2 grid grid-cols-2 lg:grid-cols-1 gap-4 mb-8 lg:mb-0">
            <button
