  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-8">
        <button onClick={() => onNavigate('landing')} className="flex items-center gap-2 text-gray-500 hover:text-gray-700 mb-6 text-sm">
          <ArrowLeft className="w-4 h-4" /> Volver
        </button>
        <h1 className="text-3xl font-display font-bold text-gray-900 border-b-2 border-primary-500 pb-3 mb-6">Política de Privacidad</h1>
        <p className="text-gray-500 text-sm mb-6">Última actualización: 1 de julio de 2026</p>
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">2. Información que recopilamos</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">3. Base legal del tratamiento</h2>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">4. Cómo usamos su información</h2>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">5. Compartición de datos</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">6. Sus derechos (RGPD)</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">7. Seguridad de datos</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">8. Autoridad de control</h2>
          <p>Puede presentar una reclamación ante la Agencia Española de Protección de Datos (AEPD): <a href="https://www.aepd.es" className="text-primary-500 hover:text-primary-600">www.aepd.es</a></p>
        </div>
      </div>
    </div>
  )
