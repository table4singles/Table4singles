  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <h1 className="text-3xl font-display font-bold text-gray-900 border-b-2 border-primary-500 pb-3 mb-6">Aviso Legal</h1>

        <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
          <h2 className="text-xl font-semibold text-gray-900 mt-8">1. Datos identificativos</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">3. Condiciones de uso</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">4. Propiedad intelectual</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">5. Responsabilidad</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">6. Legislación aplicable</h2>
