...
-- Dining tables: anyone can read, authenticated can insert, host can update
...
-- Table participants: viewable by table participants/host, authenticated can insert
...
-- Reviews: viewable by everyone, authenticated can insert
...
-- Messages: viewable by table participants
...
-- ============================================
-- Enable Realtime for chat and dashboard
-- ============================================
