  ...
  useEffect(() => {
    ...
    async function fetchStats() {
      ...
      const memberSince = profileRes.data?.created_at
        ? new Date(profileRes.data.created_at).toLocaleDateString('es-ES', { month: 'long', year: 'numeric' })
        : ''
    ...
    >
      ...
      >
        ...
        <div className="px-6 pb-6">
          {/* Avatar flotando sobre el header */}
          ...
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-0.5">Miembro de Table4Singles</p>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3 text-center">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  {stats.totalDinners === 1 ? 'cena' : 'cenas'}
                </p>
              </div>
              {stats.memberSince && (
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3 text-center">
